...
- [x] 2. Stock Service — Firestore stock management
  ...
  - [x] 2.2 Buat hook `src/hooks/useStockStatus.js`
...
- [x] 3. Pickup Schedule di PaymentModal + orderService.create()
  - [x] 3.1 Modifikasi `src/components/PaymentModal.jsx` — tambah seksi Jadwal Pengambilan
  ...
  - [x] 3.2 Modifikasi `buildWAMessage()` di `PaymentModal.jsx` — sertakan jadwal ambil
  ...
  - [x] 3.4 Modifikasi semua pemanggil `orderService.create()` — teruskan `pickupSchedule`
...
- [x] 4. Dashboard Statistik Lengkap
  - [x] 4.1 Buat fungsi kalkulasi murni di `src/utils/statsUtils.js` (file baru)
  ...
  - [x] 4.6 Integrasikan statistik baru ke tab Statistik di `src/pages/Admin.jsx`
...
- [x] 6. Notifikasi Pesanan Baru untuk Admin
  - [x] 6.1 Buat hook `src/hooks/useAdminOrdersListener.js`
  ...
  - [x] 6.2 Implementasi browser push notification di `src/pages/Admin.jsx`
  ...
  - [x] 6.3 Integrasikan `sendAdminNotification` ke callback `onNewOrder`
  ...
  - [x] 6.4 Tambah badge pending ke tab Pesanan di Admin.jsx
...
- [x] 7. Laporan Penjualan + Export Excel/PDF
  - [x] 7.1 Install library ekspor dan buat `src/services/reportService.js`
  ...
  - [x] 7.4 Buat hook `src/hooks/useSalesReport.js`
  ...
  - [x] 7.5 Buat tab Laporan di `src/pages/Admin.jsx`
...
- [x] 8. Riwayat Pelanggan Detail
  - [x] 8.1 Buat fungsi `computeCustomerList` dan `getCustomerHistory` di `src/utils/customerUtils.js` (file baru)
  ...
  - [x] 8.4 Perluas tab Pelanggan di `src/pages/Admin.jsx` — panel detail riwayat
...
- [x] 9. Stok Management Tab di Admin Panel
  - [x] 9.1 Buat tab Stok di `src/pages/Admin.jsx`
  ...
  - [x] 9.2 Tampilkan `pickupSchedule` pada setiap baris order di tab Pesanan
...
- [ ] 10. Checkpoint Final — Integrasi & Polishing
  - [x] 10.1 Update Firestore rules untuk koleksi `stock`
  ...
  - [x] 10.2 Pastikan semua imports baru ditambahkan dengan benar di `Admin.jsx`
  ...
  - [x] 10.3 Verifikasi aksesibilitas semua UI baru
